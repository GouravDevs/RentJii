...
export default function MainPageDemo() {
    ...
    const handleClick = () => {
        ...
        navigate('/acDetailPage'); // Navigate to the ProductPage component
      };

  return (
    <div class="card refrigerator-header" style={{margin:'24px'}}>
	<div class="row">
		<div class="col-md-12">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="row">
						<div class="col-sm-3" onClick={handleClick}>
						...
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<div class="img-box">
									<img src="https://rukminim2.flixcart.com/image/1200/1200/xif0q/air-conditioner-new/k/q/q/-original-imagyk7nzezzbyhc.jpeg" class="img-fluid" alt=""/>
								</div>
								<div class="thumb-content">
									<h4>Nikon DSLR</h4>
				...
				<div class="carousel-item">
					<div class="row">
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<div class="img-box">
									<img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/E-commerce/Products/img%20(4).webp" class="img-fluid" alt=""/>
								</div>
								<div class="thumb-content">
